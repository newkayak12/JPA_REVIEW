...
import entityGraph.entity.baseEntity.BaseEntity_08;
import entityGraph.entity.enums.OrderStatus_08;
...
@NoArgsConstructor
@AllArgsConstructor
@NamedEntityGraph(name = "Order_08.with Member_08", attributeNodes = {
        @NamedAttributeNode("Member_08")
})
/*
